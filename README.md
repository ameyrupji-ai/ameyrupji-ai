# Amey Rupji's AI Repo Playground


## Tests

- [Hermes Agent Docker](https://github.com/ameyrupji-ai/ameyrupji-ai-hermes-agent-docker)
...
- [open-design](https://github.com/ameyrupji-ai/open-design) - `Anthropic's Claude Design alternative`
- [open-claude-cowork](https://github.com/ameyrupji-ai/open-claude-cowork)


### AI Agents

- [openclaude](https://github.com/ameyrupji-ai/openclaude)
- [jcode](https://github.com/ameyrupji-ai/jcode)
- [opencode](https://github.com/ameyrupji-ai/opencode)
- [clawdbot](https://github.com/ameyrupji-ai/clawdbot)
- [hermes-agent](https://github.com/ameyrupji-ai/hermes-agent)

### Agent Swam / Orchestration
